...
public enum ControlTypeEnum {
	...
	VERIFY_SMS_CONTROL("VERIFY_SMS_CONTROL", "验证码验证错误次数控制", 5, 300l, ErrorCode.VERIFY_SMS_LIMIT),
	FIND_PWD_CONTROL("FIND_PWD_CONTROL", "找回密码次数控制", 5, 300l, ErrorCode.FIND_PWD_LIMIT);
