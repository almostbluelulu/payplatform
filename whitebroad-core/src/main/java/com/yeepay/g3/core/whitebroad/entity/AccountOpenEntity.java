...
import com.yeepay.g3.facade.whitebroad.enumtype.CompanyType;
import com.yeepay.g3.facade.whitebroad.enumtype.trx.AccountOpenStatus;
...
public class AccountOpenEntity implements Serializable {
	 ...
	 * 易宝商户编号
	 */
	private String ypCustomerNumber;
	
	/**
	 * 开户状态
	 */
	private AccountOpenStatus accountOpenStatus;
	...
	public String getYpCustomerNumber() {
		return ypCustomerNumber;
	}

	public void setYpCustomerNumber(String ypCustomerNumber) {
		this.ypCustomerNumber = ypCustomerNumber;
	}

	public AccountOpenStatus getAccountOpenStatus() {
		return accountOpenStatus;
	}

	public void setAccountOpenStatus(AccountOpenStatus accountOpenStatus) {
