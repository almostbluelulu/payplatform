...
import com.shentu.g3.app.pay.util.CheckUtils;
...
public class Base64 {
	...
	private static byte[] encodeBase64(byte[] binaryData, boolean isChunked) {
		...
		int var28;
		int var29;
		for (var29 = 0; var29 < numberTriplets; ++var29) {
			var28 = var29 * 3;
			var25 = binaryData[var28];
			var26 = binaryData[var28 + 1];
			byte var27 = binaryData[var28 + 2];
			var24 = (byte) (var26 & 15);
			var23 = (byte) (var25 & 3);
			val1 = (var25 & -128) == 0 ? (byte) (var25 >> 2) : (byte) (var25 >> 2 ^ 192);
			val2 = (var26 & -128) == 0 ? (byte) (var26 >> 4) : (byte) (var26 >> 4 ^ 240);
	...
	public static String encode(String str) {
		CheckUtils.notEmpty(str, "encode string");
	...
	public static String decode(String cryptoStr) {
		CheckUtils.notEmpty(cryptoStr, "decode string");

		try {
			return new String(decode(cryptoStr.getBytes()), "UTF-8");
		} catch (UnsupportedEncodingException var2) {
			throw new RuntimeException(var2.getMessage(), var2);
		}
	}
