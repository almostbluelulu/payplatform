package com.shentu.g3.facade.whitebroad.exception;
...
public class ErrorCode {
	...
	//YOP异常
	public static final String YOP_EXCEPTION = "L10004";

	//更新失败
	public static final String UPDATE_FAILED = "L20044";

	//插入失败
	public static final String CREATE_FAILED = "L20045";

	//主键冲突异常（不合理异常码，即将去除）
	public static final String DUPLICATE_KEY_EXCEPTION = "L20046";

	//查询失败
	public static final String SELECT_EXCEPTION = "L20047";

	//异步推送异常
	public static final String PUSH_TASK_EXCEPTION = "L20047";
	
	//开户记录已存在
	public static final String ACCOUNT_OPEN_EXIST_EXCEPTION = "L20048";

	//用户创建异常
	public static final String USER_CREATE_EXCEPTION = "L10012";
	...
	//结算信息不存在
	public static final String SETTLE_NOT_EXIST = "L10022";

	//远程结算信息查询异常
	public static final String SETTLE_REMOTE_EXCEPTION = "L10022";
	...
	//查询时间参数异常
	public static final String DATE_PARAM_EXCEPTION = "L10042";
	...
	//订单异常
	public static final String ORDER_EXCEPTION = "L10092";
	//通知系统异常
	...
	//订单信息不存在
	public static final String ORDER_UNKNOW_EXCEPTION = "L20045";
	/**
	 * 秘钥信息不存在
	 */
	public static final String USERKEY_NOT_EXIST_EXCEPTION = "L20046";
	/**
	 * MD5加密异常
     */
	public static final String MD5UTILS_EXCEPTION = "L20047";
	/**
	 * 查询易宝二代秘钥异常
	 */
	public static final String QUERY_YEEPAY_KEY_EXCEPTION = "L20049";
	/**
	 * Json转码异常
	 */
	public static final String QUERY_YEEPAY_GSONFORMAT_EXCEPTION = "L20050";
	/**
	 * 查询二维码信息异常
	 */
	public static final String QUERY_QRCODEINFO_EXCEPTION = "L20051";
	/**
	 *二维码未绑定商户
	 */
	public static final String QRCODE_NOBIND_EXCEPTION = "L20052";
	 ...
	 */
	//token不存在
	public static final String USER_TOKEN_NOT_EXIST = "L60001";
	
	//token已失效
	public static final String USER_TOKEN_INVALID = "L60002";
